...
export default function DashboardAdminUsers(){
    ...
    return(
        <div className="App bg-[#EFF0F3] flex min-h-screen">
                    ...
                    <input type="checkbox" id="add-user" className="modal-toggle" />
                        <div className="modal modal-bottom sm:modal-middle">
                            <div className="modal-box">
                                <label htmlFor="add-user" className="btn btn-sm btn-circle absolute right-2 top-2">✕</label>
                                ...
                                <div className="block">
                                    <div className="justify-between flex w-full mt-5">
                                        ...
                                        <input type="text" name="firstname" value={user.firstname} onChange={onChange} placeholder="Masukkan firstname ..." className="input input-bordered w-[300px]"/>
                                    </div>
                                    <div className="justify-between flex w-full mt-5">
                                        <p className="self-center">Lastname</p>
                                        <input type="text" id="" name="lastname" value={user.lastname} onChange={onChange} placeholder="Masukkan lastname ..." className="input input-bordered w-[300px]" />
                                    </div>
                                    <div className="justify-between flex w-full mt-5">
                                        <p className="self-center">Username</p>
                                        <input type="text" id="" name="username" value={user.username} onChange={onChange} placeholder="Masukkan username ..." className="input input-bordered w-[300px]" />
                                    </div>
                                    <div className="justify-between flex w-full mt-5">
                                        <p className="self-center">Password</p>
                                        <input type="password" id="" name="password" value={user.password} onChange={onChange} placeholder="Masukkan password ..." className="input input-bordered w-[300px]" />
                                    </div>
                                    <div className="justify-between flex w-full mt-5">
                                ...
                                <Button htmlFor="add-user" >Simpan</Button>
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <input type="checkbox" id="trash-icon" className="modal-toggle" />
                <div className="modal modal-bottom sm:modal-middle">
                    <div className="modal-box">
                        ...
                        <p className="py-4">Apakah anda yakin ingin menghapus user ini?</p>
                        <div className="modal-action">
            ...
            <SidebarAdmin active={NavbarAdmin.USERS}/>
            <div className='mr-[24px] w-full ml-6 pl-[240px] py-8 flex flex-col'>
                ...
                <div className="flex mt-8 gap-8">
                    {/* BUTTON */}
                    <label htmlFor="add-user" className="btn btn-primary">
                        <PlusCircleIcon className="w-6 h-6"/>
                        <p className="font-['Open Sans'] text-sm self-center ml-2">User</p>
                    </label>
                    {/* INPUT */}
