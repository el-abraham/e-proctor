...
import SidebarAdmin, {
  NavbarAdmin,
} from "../../components/sidebar/SidebarAdmin";
...
export default function AdminSiswa() {
  ...
  return (
    <div className="App bg-[#EFF0F3] flex min-h-screen">
      ...
      <SidebarAdmin active={NavbarAdmin.SISWA} />
      <div className="mr-[24px] w-full ml-6 pl-[240px] py-8 flex flex-col">
        ...
        <div className="flex justify-between">
          <div className="avatar">
            ...
            <p className="font-['Poppins'] text-sm font-medium ml-5 self-center">
              Selamat datang, Admin di E-Proctor
            </p>
          </div>
        ...
        <div className="flex mt-8 gap-8">
          ...
          <label htmlFor="add-user" className="btn btn-primary">
            ...
            <p className="font-['Open Sans'] text-sm self-center ml-2">Siswa</p>
          </label>
          {/* INPUT */}
