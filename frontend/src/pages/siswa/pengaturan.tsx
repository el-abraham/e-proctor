    ...
    <div className="App bg-[#EFF0F3] py-[30px] px-[50px] flex">
      <div className="">
        ...
        <div className="grid grid-cols-2 gap-5">
          ...
          <div className="bg-[#F7F8F9] mt-[32px] px-[50px] py-[30px] rounded-[10px]">
            <div className="border-b border-slate-300 pb-[15px]">
              <h1 className="font-semibold text-[14px] self-center">
                NAMA LENGKAP
              </h1>
            </div>
            <input
              type="text"
              placeholder="Rhaella Targaryen"
              className=" mt-[15px] input input-bordered w-full"
              disabled
            />
          </div>
        </div>
        ...
        <div className="grid grid-cols-2 gap-5">
          <div className="bg-[#F7F8F9] mt-[32px] px-[50px] py-[30px] rounded-[10px]">
            <div className="border-b border-slate-300 pb-[15px]">
              <h1 className="font-semibold text-[14px] self-center ml">
                EMAIL
              </h1>
            </div>
            <input
              type="text"
              placeholder="rhaella@gmail.com"
              className=" mt-[15px] input input-bordered w-full"
              disabled
            />
          </div>
        ...
        <div className="mt-[32px]">
          <div className="bg-[#F7F8F9] mt-[32px] px-[50px] py-[30px] rounded-[10px]">
            ...
            <p className=" mt-[15px] leading-[150%] font-['Roboto']">
              Lorem ipsum dolor sit amet, consectetur adipiscing elit. Dui eu
              ultrices purus, urna. Tristique varius nam mi eu nec. Nam netus
              sagittis at donec vel. Massa, proin cursus lobortis iaculis
              egestas nulla tortor.
            </p>
          </div>
        </div>
      ...
      <div className="ml-5">
        ...
        <div className="flex py-4 px-10 bg-[#F7F8F9] w-[310px] mt-8 rounded-[10px] cursor-pointer">
          <UserCircleIcon className="w-6 h-6 self-center mr-5" />
          <p className="font-['Open Sans'] text-sm self-center">
            Profile Settings
          </p>
        </div>
        <div className="flex py-4 px-10 bg-[#F7F8F9] w-[310px] mt-5 rounded-[10px] cursor-pointer">
