    ...
    return(
        <div className="min-w-[240px] h-screen bg-[#272343] text-[#F3FBFB] fixed">
            ...
            <div className="list-none mt-[34px] font-['Open Sans']">
                <NavLink to={"/dashboard"} className={({ isActive }) => isActive ? 'flex ml-[27px] p-[10px] rounded-l-[20px] mb-[35px] text-black bg-[#EFF0F3]' : 'flex ml-[27px] p-[10px] rounded-l-[20px] mb-[35px]'}>
                    <div className="flex">
                        <HomeIcon className="h-[20px] w-[20px] my-auto ml-[20px]"/>
                        <li className="ml-[20px] my-auto text-[14px]">Dashboard</li>
                    </div>
                </NavLink>
                <NavLink to={"/banksoal"} className={({ isActive }) => isActive ? 'flex ml-[27px] p-[10px] rounded-l-[20px] mb-[35px] text-black bg-[#EFF0F3]' : 'flex ml-[27px] p-[10px] rounded-l-[20px] mb-[35px]'}>
                    <div className="flex">
                        <BuildingLibraryIcon className="h-[20px] w-[20px] my-auto ml-[20px]"/>
                        <li className="ml-[20px] my-auto text-[14px]">Bank Soal</li>
                    </div>
                </NavLink>
                <NavLink to={"/ujiananda"} className={({ isActive }) => isActive ? 'flex ml-[27px] p-[10px] rounded-l-[20px] mb-[35px] text-black bg-[#EFF0F3]' : 'flex ml-[27px] p-[10px] rounded-l-[20px] mb-[35px]'}>
                    <div className="flex">
