...
export default function UjianHariIni(){
    return(
        <div className="text-black font-['Poppins'] max-h-[254px] mt-[24px] pb-[30px] w-[380px] bg-[#FBFCFC] rounded-[10px]">
            {/* BAGIAN HEADER */}
            ...
            <div className="mt-[20px] flex mb-[15px]">
                ...
                <div className="ml-[15px] self-center">
                    <h1 className="font-semibold text-[14px] mb-[10px]">Ujian Geografi</h1>
                    <div className="flex">
                        <ClockIcon className="w-[24px] h-[24px] mr-[10px]"/>
                        <p className="font-['Roboto'] self-center text-sm">10:45 - 12:45</p>
                    </div>
