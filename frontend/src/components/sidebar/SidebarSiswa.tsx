    ...
    return(
        <div className="min-w-[240px] h-screen bg-[#272343] text-[#F3FBFB] fixed">
            ...
            <div className="list-none mt-[34px] font-['Open Sans']">
                <NavLink to={"/siswa-dashboard"} className={ active == NavbarSiswa.DASHBOARD ? 'flex ml-[27px] p-[10px] rounded-l-[20px] mb-[35px] text-black bg-[#EFF0F3]' : 'flex ml-[27px] p-[10px] rounded-l-[20px] mb-[35px]'}>
                    <div className="flex">
                        <HomeIcon className="h-[20px] w-[20px] my-auto ml-[20px]"/>
                ...
                <NavLink to={"/siswa-ujiananda-ujian"} className={active == NavbarSiswa.UJIANANDA ? 'flex ml-[27px] p-[10px] rounded-l-[20px] mb-[35px] text-black bg-[#EFF0F3]' : 'flex ml-[27px] p-[10px] rounded-l-[20px] mb-[35px]'}>
                    <div className="flex">
                       <ClipboardIcon className="h-[20px] w-[20px] my-auto ml-[20px]"/>
                        <li className="ml-[20px] my-auto text-[14px]">Ujian Anda</li>
                    </div>
                </NavLink>
                <NavLink to={"/pengaturan"} className={active == NavbarSiswa.SETTINGS ? 'flex ml-[27px] p-[10px] rounded-l-[20px] mb-[35px] text-black bg-[#EFF0F3]' : 'flex ml-[27px] p-[10px] rounded-l-[20px] mb-[35px]'}>
                    <div className="flex">
